...
# Ensure root project directory / MEIPASS is in sys.path for PyInstaller frozen app
...
class App(ctk.CTk):
    ...
    def _fix_paste(self, entry: ctk.CTkEntry):
        ...
        inner = entry._entry  # the real tk.Entry widget inside CTkEntry
        ...
        # keycode 86 = V key on Windows regardless of layout
        inner.bind("<Control-KeyPress>", lambda e: do_paste() if e.keycode == 86 else None)
        # also keep normal bindings as fallback
