"""
Модуль фильтрации объявлений Avito
Основан на логике готового парсера parser_avito
"""
...
class AdsFilter:
    """Фильтр объявлений с цепочкой проверок"""
    ...
    def _filter_viewed(self, ads: List[Item]) -> List[Item]:
        """Фильтр уже просмотренных объявлений"""
    ...
    def _is_phrase_in_ads(ad: Item, phrases: list) -> bool:
        """Проверяет наличие фразы в объявлении"""
